...
export default function OwnerLayout({
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] flex">
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full w-[220px] bg-[#212121] border-r border-white/7
        ...
        <div className="px-4 py-4 border-t border-white/7">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-[#FF6B1A]/15 border border-[#FF6B1A]/40 flex items-center justify-center text-xs font-bold text-[#FF6B1A] flex-shrink-0">
              {user?.name
                ?.split(" ")
                .map((n) => n[0])
                .join("")
